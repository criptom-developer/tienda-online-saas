    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="container-title">
              <h3 class="tile-title">Prediccion de cotizaciones
              </h3>
              <h5 class="tile-title">
                <span id="mesSelectPredict"></span>
              </h5>
              <div class="dflex">
                <input class="month-picker freeMes" name="freeMes" placeholder="Mes">
                <button type="button" class="btnVentasMes btn btn-info btn-sm" onclick="predecirCotizacion()">
                  <i class="fa fa-binoculars" aria-hidden="true"></i>&nbsp;Predecir
                </button>
              </div>
            </div>

            <div class="box-data-reg">
              <canvas id="myChart"></canvas>
            </div>
            
            <div id="graficaMess"></div>
